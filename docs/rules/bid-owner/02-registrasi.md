...
- Pemilik Barang (Bid owner) dapat mengirim ulang notif registrasi dengan klik tombol Kirim Ulang Notifikasi Registrasi
...
- Semua field harus diisi untuk kelengkapan registrasi seperti field Provinsi, Kota, Alamat, Identitas & Logo Perusahaan => yang bertanda bintang required
  - Identitas & logo perusahaan yang bisa diupload maksimal 4 MB dgn format.jpg, .jpeg, .png (dan juga rule ini berlaku untuk NPWP dan SIUP yang diupload, pada NPWP dan SIUP format bisa .pdf juga)
- Setelah mengisi kelengkapan registrasi bid owner , akan diarahkan ke halaman akun saya dan ada notif bahwa akun menunggu validasi dari admin PHBID.
