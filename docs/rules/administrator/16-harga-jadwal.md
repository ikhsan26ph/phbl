# Harga & Jadwal
  ...
  - Secara default, tab yang pertama kali aktif pada sisi admin saat membuka menu Harga dan Jadwal adalah tab 'Semua Harga & Jadwal'.
...
## Harga
            ...
            - Admin dapat input harga mulai tanggal buka lelang sampai dengan sebelum waktu tgl rencana akhir kirim
            - Jika sudah melewati tgl rencana akhir kirim maka bidder tidak bisa input harga penawaran
            ...
            - Data biaya termasuk otomatis ngedraft dari data lelang namun admin masih bisa unceklist atau ceklist data biaya termasuk lainnya
            - Di halaman tambah harga pilihan lelang masuk ialah lelang-lelang yang aktif (yg belum melewati tgl rencana akhir kirim). Jika lelang dibatalkan maka lelang tidak dimunculkan pada pilihan lelang masuk bidder
            ...
            - Admin dapat melakukan edit nilai PPn dan PPh tersebut. Untuk penunjukkan nilai desimal, menggunakan tanda koma
            - Nilai maksimal yang dapat diinputkan adalah 100%. Jika admin menginputkan angka lebih dari 100, maka angka tersebut otomatis tereset menjadi 100
            - Nilai PPn dan PPh yang diinputkan ketika tambah harga akan selalu terbawa pada harga
            ...
            - Admin dapat edit harga jika belum melewati tgl rencana akhir kirim, jika sudah melewati tgl rencana akhir kirim maka admin tidak bisa edit dan muncul alert “Harga penawaran sudah melewati tgl. rencana akhir kirim”
            - Admin dapat hapus harga jika belum melewati tgl rencana akhir kirim, jika sudah melewati tgl rencana akhir kirim maka admin tidak bisa hapus harga dan muncul alert “Harga penawaran sudah melewati tgl. rencana akhir kirim”
            - Pada admin ada halaman Update Harga, jika klik tombol update harga diarahkan ke halaman Update Harga
            ...
            - Admin dapat mengedit nilai PPn dan PPh. Setelah selesai diedit, nilai PPn dan PPh akan otomatis diganti dengan inputan data terbaru
            ...
            - Pada update harga, jika harga sama seperti sebelumnya maka bisa ceklist checkbox “Harga Seperti Sebelumnya”
            ...
            - Admin dapat melakukan edit nilai PPn dan PPh ketika update harga
            ...
            - Jika harga beda maka bisa inputkan nominal yang sesuai
...
- Admin dapat input jadwal mulai dari buka lelang sampai dengan sebelum melewati tgl rencana akhir kirim
- Jika melewati tgl rencana akhir kirim maka Admin tidak bisa input jadwal dan muncul alert “Lelang sudah melewati rencana akhir kirim. Tidak bisa tambah jadwal”
...
- Jika pada template excel data jadwal yang diinputkan lebih dari 50 maka ketika import jadwal tidak bisa karena baatsan maksimalnya 50 data
...
- Admin dapat edit jadwal apabila belum melewati h+2 ETA. Jika sudah melewati h+2 dari tgl ETA maka tidak bisa edit jadwal
- Jika admin edit jadwal maka tanggal closing time dapat dimundurkan minimal sampai tgl mulai berlaku harganya, kemudian untuk tgl ETD tidak bisa kurang dari closing time dan ETA tidak bisa kurang dari ETD
- Admin dapat hapus jadwal apabila jadwal tersebut belum ada ordernya. Jika jadwal sudah ada ordernya maka tidak bisa hapus dan muncul alert “Jadwal sudah di order tidak bisa di hapus”
